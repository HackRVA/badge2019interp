...
SRC_BADGE_C = src/LCDcolor.c src/S6B33.c src/badge.c src/fb.c \
	...
	src/buttons.c src/settings.c src/menu.c

SRC_APPS_C = badge_apps/blinkenlights.c badge_apps/conductor.c
...
#$(BUILD)/firmware.elf:	$(BDGOBJ) $(USBOBJ)

$(BUILD)/firmware.elf:	$(BDGOBJ) $(USBOBJ) $(APPOBJ)
	echo $@
