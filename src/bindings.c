...
struct binding_t bindings[] = {
    ...
    {.vf.ucp       = &G_down_button_cnt},
    {.vf.ucp       = &G_left_button_cnt},
    {.vf.ucp       = &G_right_button_cnt},
    {.vf.ucp       = &(wclock.hour)},
    {.vf.ucp       = &(wclock.min)},
    {.vf.ucp       = &(wclock.sec)},
    {.vf.usp       = &G_sysData.badgeId},
    {.vf.cp        = G_sysData.name},
    {.vf.cuip      = G_flashstart},
    {.vf.vfn_uc_i  = (drawLCD8)},
    {.vf.c         = DRBOB},
    {.vf.vfn       = (adc_cb)},
    {.vf.vfni      = (setRotate)},
    {.vf.vfnuc     = (led_brightness)},
    {.vf.cp        = &G_mute},
    {.vf.ifni      = (returnVal)},
};
